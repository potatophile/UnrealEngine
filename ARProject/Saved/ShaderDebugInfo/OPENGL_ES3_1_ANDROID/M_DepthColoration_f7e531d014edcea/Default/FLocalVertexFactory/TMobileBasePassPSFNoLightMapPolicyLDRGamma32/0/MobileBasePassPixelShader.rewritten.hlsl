...
float3 select_internal(bool c, float3 a, float3 b) {
  return float3(c ? a.x : b.x, c ? a.y : b.y, c ? a.z : b.z);
}
...
cbuffer Material {
  const float4 Material_PreshaderBuffer[12];
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs) {
  ...
  min16float Local10 = (Local8.r * Material_PreshaderBuffer[0].x);
  min16float Local11 = (Local10 - Material_PreshaderBuffer[3].x);
  min16float Local12 = (Local11 * Material_PreshaderBuffer[3].w);
  min16float Local13 = saturate(Local12);
  min16float3 Local14 = lerp(Material_PreshaderBuffer[5].xyz, Material_PreshaderBuffer[4].xyz, Local13);
  min16float Local15 = (Local10 - Material_PreshaderBuffer[7].x);
  min16float Local16 = (Local15 * Material_PreshaderBuffer[7].z);
  min16float Local17 = saturate(Local16);
  min16float3 Local18 = lerp(Material_PreshaderBuffer[8].xyz, Material_PreshaderBuffer[5].xyz, Local17);
  min16float3 Local19 = select_internal((abs(Local10 - Material_PreshaderBuffer[3].x) > 1.0000000000000001E-5), select_internal((Local10 >= Material_PreshaderBuffer[3].x), Local14, Local18), Local18);
  min16float Local20 = (Local10 - 0.);
  min16float Local21 = (Local20 * Material_PreshaderBuffer[10].y);
  min16float Local22 = saturate(Local21);
  min16float3 Local23 = lerp(Material_PreshaderBuffer[11].xyz, Material_PreshaderBuffer[8].xyz, Local22);
  min16float3 Local24 = select_internal((abs(Local10 - Material_PreshaderBuffer[7].x) > 1.0000000000000001E-5), select_internal((Local10 >= Material_PreshaderBuffer[7].x), Local19, Local23), Local23);
  PixelMaterialInputs.EmissiveColor = Local24;
...
#line 3497 "/Engine/Generated/Material.ush"
void ClipLODTransition(FMaterialPixelParameters Parameters) {
}


#line 3531 "/Engine/Generated/Material.ush"
...
#line 3630 "/Engine/Generated/Material.ush"
bool IsOrthoProjection(ViewState InView) {
  return InView.ViewToClip[3][3] >= 1.F;
}


#line 3636 "/Engine/Generated/Material.ush"
...
#line 3825 "/Engine/Generated/Material.ush"
...
#line 616 "/Engine/Private/BRDF.ush"
min16float EnvBRDFApproxNonmetal(min16float Roughness, min16float NoV) {
  const min16float2 c0 = { -1, -0.0275 };
  const min16float2 c1 = { 1, 0.042500000000000003 };
  min16float2 r = Roughness * c0 + c1;
  return min(r.x * r.x, exp2(-9.2799999999999994 * NoV)) * r.x + r.y;
}
