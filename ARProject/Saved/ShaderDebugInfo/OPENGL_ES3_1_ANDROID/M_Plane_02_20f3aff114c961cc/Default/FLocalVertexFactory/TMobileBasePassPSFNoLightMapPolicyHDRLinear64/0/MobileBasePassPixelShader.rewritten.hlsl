...
cbuffer Material {
  const float4 Material_PreshaderBuffer[2];
...
#line 3088 "/Engine/Generated/Material.ush"
...
#line 3128 "/Engine/Generated/Material.ush"
...
#line 3138 "/Engine/Generated/Material.ush"
...
#line 3236 "/Engine/Generated/Material.ush"
...
#line 3342 "/Engine/Generated/Material.ush"
...
#line 3347 "/Engine/Generated/Material.ush"
...
#line 3352 "/Engine/Generated/Material.ush"
struct FMaterialRefractionData {
  float2 Data;
  float RefractionDepthBias;
};
#line 3428 "/Engine/Generated/Material.ush"
...
#line 3489 "/Engine/Generated/Material.ush"
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs) {
  ...
  FLWCVector2 Local4 = MakeLWCVector(LWCGetComponent(Local3, 0), LWCGetComponent(Local3, 1));
  FLWCVector3 Local5 = ResolvedView.WorldCameraOrigin;
  FLWCVector2 Local6 = LWCSubtract(Local4, MakeLWCVector(LWCGetComponent(Local5, 0), LWCGetComponent(Local5, 1)));
  min16float2 Local7 = LWCToFloat(Local6);
  min16float Local8 = length(Local7);
  min16float Local9 = min16float(Parameters.TexCoords[0].x);
  min16float Local10 = (Local9 * 0.10000000000000001);
  min16float Local11 = (Local8 / Local10);
  min16float Local12 = (Local11 - View_GameTime);
  min16float Local13 = (Local12 * 6.2831854800000002);
  min16float Local14 = sin(Local13);
  min16float Local15 = lerp((0. - 5.), (5. + 1.), Local14);
  min16float Local16 = saturate(Local15);
  min16float Local17 = Local16.r;
  min16float3 Local18 = (Material_PreshaderBuffer[1].xyz * ((min16float3)Local17));
  min16float3 Local19 = (Local18 * ((min16float3)2.));
  min16float2 Local20 = GetViewportUV(Parameters);
  min16float Local21 = Local20.r;
  min16float4 Local22 = lerp(ResolvedView.XRPassthroughCameraUVs[0], ResolvedView.XRPassthroughCameraUVs[1], Local21);
  min16float Local23 = Local20.g;
  min16float2 Local24 = Local22.ba;
  min16float2 Local25 = Local22.rg;
  min16float2 Local26 = lerp(Local25, Local24, Local23);
  min16float Local27 = 1.F;
  min16float4 Local28 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_0, Material_Texture2D_0Sampler, Local26));
  min16float Local29 = 1.F;
  min16float Local30 = saturate(Local28.r);
  min16float Local31 = (1. - Local30);
  min16float3 Local32 = (Local19 * ((min16float3)Local31));
  ...
  PixelMaterialInputs.Refraction = min16float3(min16float3(1., 0., 0.).xy, Material_PreshaderBuffer[1].w);
