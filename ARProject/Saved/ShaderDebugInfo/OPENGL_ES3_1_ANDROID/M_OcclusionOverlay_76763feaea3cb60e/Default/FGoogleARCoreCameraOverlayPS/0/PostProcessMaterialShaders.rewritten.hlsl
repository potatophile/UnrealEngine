...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs) {
  ...
  min16float4 Local10 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_1, Material_Texture2D_1Sampler, Local6));
  min16float Local11 = 1.F;
  PixelMaterialInputs.EmissiveColor = Local8.rgb;
  PixelMaterialInputs.Opacity = Local10.r;
  ...
  PixelMaterialInputs.Refraction = min16float3(min16float3(1., 0., 0.).xy, Material_PreshaderBuffer[0].x);
...
#line 3604 "/Engine/Generated/Material.ush"
...
#line 3705 "/Engine/Generated/Material.ush"
