...
#line 14 "/Engine/Generated/UniformBuffers/Material.ush"
Texture2D<vector<float, 4> > Material_Texture2D_0;
#line 15 "/Engine/Generated/UniformBuffers/Material.ush"
...
float2 LWCGetTileOffset(FLWCVector2 V) {
...
FLWCVector2 MakeLWCVector(FLWCScalar X, FLWCScalar Y) {
  return MakeLWCVector2(float2(((X).Tile), ((Y).Tile)), float2(X.Offset, Y.Offset));
}
...
float2 LWCToFloat(FLWCVector2 Value) {
...
FLWCVector2 LWCSubtract(FLWCVector2 Lhs, FLWCVector2 Rhs) {
  return MakeLWCVector2(((Lhs).Tile) - ((Rhs).Tile), Lhs.Offset - Rhs.Offset);
}
...
#line 1301 "/Engine/Private/Common.ush"
...
#line 165 "/Engine/Generated/Material.ush"
struct FStrataData {
  uint Dummy;
};
...
#line 339 "/Engine/Generated/Material.ush"
...
#line 365 "/Engine/Generated/Material.ush"
...
#line 571 "/Engine/Generated/Material.ush"
...
#line 583 "/Engine/Generated/Material.ush"
...
#line 3069 "/Engine/Generated/Material.ush"
...
#line 3161 "/Engine/Generated/Material.ush"
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs) {
  ...
  min16float2 Local3 = GetViewportUV(Parameters);
  min16float2 Local4 = min16float2(ViewportUVToBufferUV(Local3));
  min16float2 Local5 = max(Local4, ResolvedView.BufferBilinearUVMinMax.xy);
  min16float2 Local6 = min(Local5, ResolvedView.BufferBilinearUVMinMax.zw);
  min16float Local7 = CalcSceneDepth(Local6);
  min16float Local8 = (Local7.r * Material_PreshaderBuffer[0].y);
  min16float Local9 = Local3.r;
  min16float4 Local10 = lerp(ResolvedView.XRPassthroughCameraUVs[0], ResolvedView.XRPassthroughCameraUVs[1], Local9);
  min16float Local11 = Local3.g;
  min16float2 Local12 = Local10.ba;
  min16float2 Local13 = Local10.rg;
  min16float2 Local14 = lerp(Local13, Local12, Local11);
  min16float Local15 = 1.F;
  min16float4 Local16 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_0, Material_Texture2D_0Sampler, Local14));
  min16float Local17 = 1.F;
  min16float Local18 = (Local8 - Local16.r);
  min16float Local19 = abs(Local18);
  min16float Local20 = select_internal((abs(Local19 - Material_PreshaderBuffer[0].z) > 1.0000000000000001E-5), select_internal((Local19 >= Material_PreshaderBuffer[0].z), 0., 1.), 0.);
  min16float3 Local21 = (((min16float3)Local20) * Material_PreshaderBuffer[2].xyz);
  FLWCVector3 Local22 = GetWorldPosition(Parameters);
  FLWCVector2 Local23 = MakeLWCVector(LWCGetComponent(Local22, 0), LWCGetComponent(Local22, 1));
  FLWCVector3 Local24 = ResolvedView.WorldCameraOrigin;
  FLWCVector2 Local25 = LWCSubtract(Local23, MakeLWCVector(LWCGetComponent(Local24, 0), LWCGetComponent(Local24, 1)));
  min16float2 Local26 = LWCToFloat(Local25);
  min16float Local27 = length(Local26);
  min16float Local28 = min16float(Parameters.TexCoords[0].x);
  min16float Local29 = (Local28 * 0.10000000000000001);
  min16float Local30 = (Local27 / Local29);
  min16float Local31 = (Local30 - View_GameTime);
  min16float Local32 = (Local31 * 6.2831854800000002);
  min16float Local33 = sin(Local32);
  min16float Local34 = lerp((0. - 5.), (5. + 1.), Local33);
  min16float Local35 = saturate(Local34);
  min16float Local36 = Local35.r;
  min16float3 Local37 = (Local21 * ((min16float3)Local36));
  FLWCVector3 Local38 = LWCSubtract(Local22, Local24);
  min16float3 Local39 = LWCToFloat(Local38);
  min16float Local40 = length(Local39);
  min16float Local41 = (Local40 / 250.);
  min16float Local42 = saturate(Local41);
  min16float Local43 = (1. - Local42);
  PixelMaterialInputs.EmissiveColor = Local37;
  PixelMaterialInputs.Opacity = Local43;
  ...
  PixelMaterialInputs.Refraction = min16float3(min16float3(1., 0., 0.).xy, Material_PreshaderBuffer[2].w);
...
#line 3826 "/Engine/Generated/Material.ush"
...
#line 3925 "/Engine/Generated/Material.ush"
bool IsOrthoProjection(ViewState InView) {
  return InView.ViewToClip[3][3] >= 1.F;
}


#line 3931 "/Engine/Generated/Material.ush"
...
#line 4039 "/Engine/Generated/Material.ush"
...
#line 4120 "/Engine/Generated/Material.ush"
...
void Main(FVertexFactoryInterpolantsVSToPS Interpolants, FSharedMobileBasePassInterpolants BasePassInterpolants, in float4 SvPosition : SV_Position, in bool bIsFrontFace : SV_IsFrontFace, out min16float4 OutColor : SV_Target0) {
  ...
  Color += Emissive;
  OutColor = min16float4(Color * (VertexFog.a * Opacity.x), 0.F);
